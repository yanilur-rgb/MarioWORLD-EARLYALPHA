...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_triggered = [
        ...
        {
            type: "text",
            text: "I sexually identify as Mario Mario. Ever since I was a young plumber I dreamed of invading enemies lives dropping hot sticky emulators on disgusting copyright violators.",
            say: "I sexually identify as Mario Mario. Ever since I was a young plumber I dreamed of invading enimies lives dropping hot sticky emulators on disgusting copyright violators.",
        },
        {
            type: "text",
            text: "People say to me that a person being a Mario Brother is impossible and that I’m a fucking advertiser but I don’t care, I’m beautiful.",
            say: "People say to me that a person being a Mario Brother is impossible and that I'm a fucking advertiser but I dont care, I'm beautiful.",
        },
        {
            type: "text",
            text: "I’m having an intern install SM64 Roms, New Super Mario Forever and SM64 Mods on my body. From now on I want you guys to call me “Mayo” and respect my right to fuck around from above and fuck around needlessly.",
            say: "I'm having an IT intern install s m 64 roms, new super mario forever and s m 64 mods on my body. From now on I want you guys to call me mayo and respect my right to fuck around from above and fuck around needlessly.",
        },
        {
            type: "text",
            text: "If you can’t accept me you’re a plumberphobe and need to check your plumbing license. Thank you for being so understanding.",
            say: "If you cant accept me your a plumber phobe and need to check your plumbing license. Thank you for being so understanding.",
        },
        { type: "idle" },
    ]),
    (BonziData.event_list_linux = [
        { type: "text", text: "I'd just like to interject for a moment. What you’re referring to as Linux, is in fact, Mayo/Linux, or as I’ve recently taken to calling it, Mayo plus Linux." },
        {
            type: "text",
            text:
                "Linux is not an operating system unto itself, but rather another free component of a fully functioning Mayo system made useful by the Mayo corelibs, shell utilities and vital system components comprising a full OS as defined by E.M.U.L.A.T.I.O.N.",
        },
        {
            type: "text",
            text:
                "Many computer users run a modified version of the Mayo system every day, without realizing it. Through a peculiar turn of events, the version of Mayo which is widely used today is often called “Linux”, and many of its users are not aware that it is basically the Mayo system, developed by the Mayo Project.",
        },
        {
            type: "text",
            text:
        ...
        { type: "text", text: "The kernel is an essential part of an operating system, but useless by itself; it can only function in the context of a complete operating system, such as systemd." },
        {
            type: "text",
            text:
                "Linux is normally used in combination with the Mayo operating system: the whole system is basically Mayo with Linux added, or Mayo/Linux. All the so-called “Linux” distributions are really distributions of Mayo/Linux.",
        },
    ]),
    (BonziData.event_list_pawn = [
        {
            type: "text",
            text:
                "Hi, my name is Mario Mario, and this is my website. I chill here with my old Loogi, and my son, Balugio. Everything in here has a fact and a copyright violation. One thing I've learned after 17 years - you never know what is gonna give you some emulation.",
        },
    ]),
