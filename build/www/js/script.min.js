    ...
    BonziData = {
        ...
        event_list_joke_open: [
            [
                ...
                { type: "text", text: '"Haha, look at the stupid {COLOR} plumber telling jokes!" Fuck you. It isn\'t funny.', say: "Hah hah! Look at the stupid {COLOR} plumber telling jokes! Fuck you. It isn't funny." },
        ...
        event_list_joke_mid: [
            ...
            [
                ...
                { type: "text", text: "Because we KNEAD it. Haha please send money to my PayPal at nigerianprince99@virus.com" },
            ],
            [
        ...
        event_list_fact_mid: [
            ...
            [
                { type: "anim", anim: "earth_fwd", ticks: 15 },
                { type: "text", text: "Fun Fact: Joseph Judge was lazy in terms of Fun Facrs when developing BonziWORLD, hence why only 2 facts were written initially.", say: "Fun Fact: Joseph Judge was lazy in terms of Fun Facrs when developing Bonzi world, hence why only 2 facts were written initially." },
                { type: "anim", anim: "earth_back", ticks: 15 },
                { type: "anim", anim: "grin_fwd", ticks: 15 },
        ],
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_triggered = [
        ...
        {
            type: "text",
            text: "I sexually identify as Mario Mario. Ever since I was a young plumber I dreamed of invading desktops dropping hot sticky tootorals on disgusting PC users.",
            say: "I sexually identify as Mario Mario. Ever since I was a young plumber I dreamed of invading desktops dropping hot sticky tootorals on disgusting PC users.",
        },
        {
            type: "text",
            text: "People say to me that a person being a Mario Brother is impossible and that I’m a fucking advertiser if you've been on other servers but I don’t care, I’m beautiful.",
            say: "People say to me that a person being a Mario Brother is impossible and that I'm a fucking advertiser if you've been on other servers but I dont care, I'm beautiful.",
        },
        {
            type: "text",
            text: "I’m having an intern install New Super Mario Forever, N E S Emulators and S M 64 Mods on my body. From now on I want you guys to call me “Mayo” and respect my right to fuck around from above and fuck around needlessly.",
            say: "I’m having an intern install New Super Mario Forever, N E S Emulators and S M 64 Mods on my body. From now on I want you guys to call me “Mayo” and respect my right to fuck around from above and fuck around needlessly.",
        },
        {
            type: "text",
            text: "If you can’t accept me you’re a plumber-phobe and need to check your plumber license. Thank you for being so understanding.",
            say: "If you can’t accept me you’re a plumber-phobe and need to check your plumber license. Thank you for being so understanding.",
        },
        { type: "idle" },
    ]),
    (BonziData.event_list_linux = [
        { type: "text", text: "I'd just like to interject for a moment. What you’re referring to as Linux, is in fact, MAYRO/Linux, or as I’ve recently taken to calling it, Mayro plus Linux." },
        {
            type: "text",
            text:
                "Linux is not an operating system unto itself, but rather another free component of a fully functioning Mayro system made useful by the Mayro corelibs, shell utilities and vital system components comprising a full OS as defined by E.M.U.L.A.T.O.R.",
        },
        {
            type: "text",
            text:
                "Many computer users run a modified version of the Mayro system every day, without realizing it. Through a peculiar turn of events, the version of Mayro which is widely used today is often called “Linux”, and many of its users are not aware that it is basically the Mayro system, developed by the Mayro Project.",
        },
        {
            type: "text",
            text:
                "There really is a Linux, and these people are using it, but it is just a part of the system they use. Linux is the kernel: the program in the system that allocates the machine’s fuckery to the other programs that you run. ",
        },
        { type: "text", text: "The kernel is an essential part of an operating system, but useless by itself; it can only function in the context of a complete operating system, such as systemd." },
        {
            type: "text",
            text:
                "Linux is normally used in combination with the Mayro operating system: the whole system is basically Mayro with Linux added, or MAYRO/Linux. All the so-called “Linux” distributions are really distributions of MAYRO/Linux.",
        },
    ]),
    (BonziData.event_list_pawn = [
        {
            type: "text",
            text:
                "Hi, my name is Mario Mario, and this is my website. I plumb here with my old Loogi, and my son, Balugio. Everything in here has a copyright violation and an emulation. One thing I've learned after 17 years - you never know what is gonna give you some emulation.",
        },
    ]),
